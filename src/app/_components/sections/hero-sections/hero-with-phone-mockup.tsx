      ...
      <div className="relative isolate">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            >
              Seamless Car Rental Experience 1
            </h1>
            <p
            ...
            >
              Experience hassle-free car rentals with our innovative platform. No long queues, no hidden fees, just pure convenience. Find the perfect car for your journey, every time. 2
            </p>
            <div className="mt-10 flex items-center gap-x-6">
              <Button theme={theme} href="#">
                Start Your Journey 3
              </Button>
